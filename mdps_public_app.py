# -*- coding: utf-8 -*-
"""
Created on Sat Jul 27 15:09:42 2024
...
if selected == 'Heart Disease Prediction':
    ...
    with col1:
        thal = st.text_input('thal:0 = normal; 1 = fixed defect 2 = reversabledefect')
...
if selected =="Parkinsons Prediction":
    ...
    with col4:
        Jitter_percent = st.text_input('MDVP:Hitter(%')
    ...
    with col4:
         Shimmer = st.text_input('MDPA:Shimmer')
    
    with col5:
         Shimmer_db = st.text_input('MDPA:Shimmer(db)')
    ...
    if st.button("Parkinson's Test Result"):
        ...
        if parkinsons_prediction[0] == 1:
            parkisons_diagnosis = "The person has Parkinson's disease"
            
        else:
            parkisons_diagnosis = "The person does not have Parkinson's disease"
    
    st.success(parkisons_diagnosis)
